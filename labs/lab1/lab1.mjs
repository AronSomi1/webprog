 ...
 * If you call a property that is not present in the object, undefined will be returend
 ...
 * In first case all keys will allways be printed, but in the second case
 * attributes that are not enumerable will be skipped. 
 */
